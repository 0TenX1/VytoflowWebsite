...
>
  ...
  >
      ...
      <div className="relative p-8  w-full h-full bg-transparent" ref={ref}>
        <motion.h1
          className="lg:text-6xl md:text-6xl text-5xl flex mt-32 lg:mt-16 text-black font-semibold"
          initial="hidden"
          animate={controls}
          variants={{
...
Unlocking your potential for digital transformation and success.
        ...
        <div className="relative">
          <Slider {...settings1} className="absolute -top-36 lg:top-[-10rem] right-[-1.5rem] md:w-full lg:right-[-2rem] w-[730px] lg:w-[830px]  h-[800px]">
            <motion.div
