          ...
          <div className="flex py-4 items-center px-2 lg:px-8 xl:px-10 max-lg:py-4">
            ...
            >
              ...
              {isComingSoonHovered && (
                ...
                >
                  Community
                  <span className="absolute top-[3.09rem] left-[1.6rem] w-full h-[0.2rem] bg-cyan-800 transform origin-left scale-x-0 transition-transform duration-
  300 group-hover:scale-x-50"></span>
  </Link>
